import 'mocha';
import { Model, ModelBuilder, DataObject, Absolute2DPosition, DataFrame, CallbackSinkNode } from '@openhps/core';
import { CSVDataSource, CSVDataSourceOptions } from '../../src';
...
describe('csv source', () => {
    it('use case 1', (done) => {
        ModelBuilder.create()
            .from(
                new CSVDataSource('test/data/example1.csv', (row: any) => {
    ...
    it('use case 4', (done) => {
        ModelBuilder.create()
            .from(
                new (class ABC extends CSVDataSource<DataFrame> {
